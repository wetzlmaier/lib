...
public interface IVMWareVirtualMachine extends Com4jObject {
    ...
    @VTID(22)
    com.vestris.vmwarecomtools.IProcess detachProgramInGuest(
        java.lang.String guestProgramName,
        java.lang.String commandLineArgs);

    @VTID(23)
    com.vestris.vmwarecomtools.IProcess detachProgramInGuest2(
        java.lang.String guestProgramName,
        java.lang.String commandLineArgs,
        int timeoutInSeconds);

    @VTID(24)
    com.vestris.vmwarecomtools.IProcess detachScriptInGuest(
        java.lang.String interpreter,
        java.lang.String scriptText);

    @VTID(25)
    com.vestris.vmwarecomtools.IProcess detachScriptInGuest2(
        java.lang.String interpreter,
        java.lang.String scriptText,
        int timeoutInSeconds);
    ...
    @VTID(32)
    com.vestris.vmwarecomtools.IGuestFileInfo getFileInfoInGuest(
        java.lang.String guestPathName);

    @VTID(33)
    com.vestris.vmwarecomtools.IGuestFileInfo getFileInfoInGuest2(
        java.lang.String guestPathName,
        int timeoutInSeconds);

    @VTID(34)
    com.vestris.vmwarecomtools.IVariableIndexer guestEnvironmentVariables();

    @VTID(34)
    @ReturnValue(defaultPropertyThrough={com.vestris.vmwarecomtools.IVariableIndexer.class})
    java.lang.String guestEnvironmentVariables(
        java.lang.String name);

    @VTID(35)
    com.vestris.vmwarecomtools.IVariableIndexer guestVariables();
    ...
    @VTID(64)
    com.vestris.vmwarecomtools.IProcess runProgramInGuest(
        java.lang.String guestProgramName,
        java.lang.String commandLineArgs);

    @VTID(65)
    com.vestris.vmwarecomtools.IProcess runProgramInGuest2(
        java.lang.String guestProgramName,
        java.lang.String commandLineArgs,
        int options,
        int timeoutInSeconds);
    ...
    @VTID(66)
    com.vestris.vmwarecomtools.IProcess runScriptInGuest(
        java.lang.String interpreter,
        java.lang.String scriptText);

    @VTID(67)
    com.vestris.vmwarecomtools.IProcess runScriptInGuest2(
        java.lang.String interpreter,
        java.lang.String scriptText,
        int options,
        int timeoutInSeconds);
    ...
    @VTID(68)
    com.vestris.vmwarecomtools.IVariableIndexer runtimeConfigVariables();
    ...
    @VTID(78)
    com.vestris.vmwarecomtools.IVMWareRootSnapshotCollection snapshots();

    @VTID(79)
    com.vestris.vmwarecomtools.IVMWareSnapshot beginRecording(
        java.lang.String name,
        java.lang.String description);

    @VTID(80)
    com.vestris.vmwarecomtools.IVMWareSnapshot beginRecording2(
        java.lang.String name,
        java.lang.String description,
        int timeoutInSeconds);
