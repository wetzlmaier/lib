...
namespace Scch.Mvvm.Service
{
    ...
    public class FileDialogService : IFileDialogService
    {
        ...
        public FileDialogResult ShowOpenFileDialog(Window owner, IEnumerable<FileType> fileTypes, FileType defaultFileType, string defaultFileName)
        {
            ...
            var dialog = new OpenFileDialog {Title = Resources.FileDialogService_Open_Title};
        ...
        public FileDialogResult ShowSaveFileDialog(Window owner, IEnumerable<FileType> fileTypes, FileType defaultFileType, string defaultFileName)
        {
            ...
            var dialog = new SaveFileDialog {Title = Resources.FileDialogService_SaveAs_Title};

            return ShowFileDialog(owner, dialog, fileTypes, defaultFileType, defaultFileName);
        }

        private static FileDialogResult ShowFileDialog(Window owner, FileDialog dialog, IEnumerable<FileType> fileTypes, 
