...
namespace Scch.Mvvm.Service
{
    ...
    public interface IFileDialogService
    {
        ...
        FileDialogResult ShowOpenFileDialog(Window owner, IEnumerable<FileType> fileTypes, FileType defaultFileType, string defaultFileName);
        ...
        /// <exception cref="ArgumentNullException">fileTypes must not be null.</exception>
        /// <exception cref="ArgumentException">fileTypes must contain at least one item.</exception>
        FileDialogResult ShowSaveFileDialog(Window owner, IEnumerable<FileType> fileTypes, FileType defaultFileType, string defaultFileName);
    }
}
