...
{
    public abstract class EntityFrameworkCrudService<TKey, TEntity> : IEntityFrameworkCrudService<TKey, TEntity>
        where TEntity : class, IEntityFrameworkEntity<TKey>, new()
        where TKey : IComparable<TKey>, IEquatable<TKey>
    {
        protected IEntityFrameworkRepositoryFactory<TKey> Factory { get; private set; }

        protected EntityFrameworkCrudService(IEntityFrameworkRepositoryFactory<TKey> factory)
        {
            Factory = factory;
        }
        ...
        public TEntity LoadById(TKey id, EntityView<TEntity> view = null)
        {
            ...
            {
                throw EntityFrameworkExceptionHelper.HandleException(ex);
            }
        }

        public TEntity LoadById(IEntityFrameworkRepository<TKey> repository, TKey id, EntityView<TEntity> view = null)
        {
        ...
        public IEnumerable<TEntity> LoadByIds(IEntityFrameworkRepository<TKey> repository, IEnumerable<TKey> ids, EntityView<TEntity> view = null)
        {
            IObjectQuery<TEntity> query = repository.GetQuery<TEntity>();
            query = BusinessHelper.ApplyView(query, view);
        ...
        /// <summary>
        /// <see cref="IEntityFrameworkCrudService{TKey, TEntity}.Exists(TKey)"/>
        /// </summary>
        /// <param name="id"></param>
        /// <returns></returns>
        ...
        public bool Exists(IEntityFrameworkRepository<TKey> repository, TKey id)
        {
        ...
        public IEnumerable<TEntity> LoadAll(IEntityFrameworkRepository<TKey> repository, EntityView<TEntity> view = null)
        {
            IObjectQuery<TEntity> query = repository.GetQuery<TEntity>();
            query = BusinessHelper.ApplyView(query, view);
        ...
        public void Save(IEntityFrameworkRepository<TKey> repository, TEntity entity)
        {
        ...
        public void SaveAll(IEntityFrameworkRepository<TKey> repository, IEnumerable<TEntity> entities)
        {
            repository.UnitOfWork.BeginTransaction();
        ...
        public void Delete(IEntityFrameworkRepository<TKey> repository, TEntity entity)
        {
            if (Equals(entity, default(TEntity)))
                throw new ArgumentNullException("entity");
        ...
        public IEnumerable<TEntity> Find(IEntityFrameworkRepository<TKey> repository, Expression<Func<TEntity, bool>> criteria, EntityView<TEntity> view = null)
        {
            IObjectQuery<TEntity> query = repository.GetQuery<TEntity>();
            query = BusinessHelper.ApplyView(query, view);
